...
export const ABILITY_DEFINITIONS: Record<AbilityId, AbilityDefinition> = {
  fireball: {
    ...
    color: 0xff6b35,
    cssColor: '#ff6b35',
    description: 'Yeet a giant explosive spicy meatball into the monster mob!',
    shortRole: 'SPICY EXPLOSION',
    baseCooldown: 7.0,
    worldId: 1,
  ...
  freeze: {
    ...
    color: 0x5ddcff,
    cssColor: '#5ddcff',
    description: 'Turn nearby monsters into grumpy, shivering popsicles.',
    shortRole: 'POPSICLE FREEZE',
    baseCooldown: 11.0,
    worldId: 1,
  ...
  heal: {
    ...
    color: 0x48e076,
    cssColor: '#48e076',
    description: 'Munch a tasty burrito to restore 20% max health over 4s.',
    shortRole: 'BURRITO HEAL',
    baseCooldown: 34.0,
    worldId: 2,
  ...
  'arcane-beam': {
    ...
    color: 0xa87aff,
    cssColor: '#a87aff',
    description: 'ZAP everything in a line with a giant purple laser pointer!',
    shortRole: 'GIANT LAZER',
    baseCooldown: 13.5,
    worldId: 2,
...
export const ABILITY_UPGRADES: Record<AbilityId, AbilityUpgradeSpec> = {
  ...
  heal: {
    effects: [
      '+6% extra heal (26% HP) 🌯',
      '-6s cooldown ⚡',
      'Faster munching (3.2s) ⏰',
      '+8% extra heal (34% HP) 🍕',
      '-8s cooldown & ward shield 🛡️',
    ],
  },
  'arcane-beam': {
    effects: [
      ...
      '-20% cooldown ⚡',
      '+45% mega zap damage 💥',
      'Laser leaves burning spicy trail 🔥',
    ],
  },
};
