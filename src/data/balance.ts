import type { EnemyKind, PassiveId, WeaponId } from '../types';
...
export const WEAPON_BALANCE: Record<WeaponId, { name: string; baseDamage: number; cooldown: number; color: number }> = {
  'magic-bolt': { name: 'Magic Bolt', baseDamage: 22, cooldown: 0.92, color: 0x5ddcff },
  'fire-orb': { name: 'Fire Orb', baseDamage: 28, cooldown: 2.7, color: 0xff9c47 },
  'orbiting-blades': { name: 'Orbiting Blades', baseDamage: 18, cooldown: 0.7, color: 0xc9ddff },
  'chain-lightning': { name: 'Chain Lightning', baseDamage: 34, cooldown: 3.4, color: 0x9f8cff },
};
